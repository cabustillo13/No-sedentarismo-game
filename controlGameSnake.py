...
while True:
    ...
    for i in np.arange(1, len(pts)):
        ...
        if counter >= 10 and i == 1 and pts[-10] is not None:
            ...
            if np.abs(dX) > 50:
                dirX = 'Oeste' if np.sign(dX) == 1 else 'Este'

            if np.abs(dY) > 50:
                dirY = 'Norte' if np.sign(dY) == 1 else 'Sur'
    ...
    #Si es detectada la direccion Este, apretar el boton de la flecha derecha ->. 
    if direction == 'Este':
        if last_pressed != 'right':
            ...
            print("Right Pressed")
            #pyautogui.PAUSE = 2
    #Si es detectada la direccion Oeste, apretar el boton de la flecha izquierda <-.
        ...
        if last_pressed != 'left':
            ...
            print("Left Pressed")
            #pyautogui.PAUSE = 2
    #Si es detectada la direccion Norte, presionar el boton de la flecha para arriba. 
        ...
        if last_pressed != 'up':
            ...
            print("Up Pressed")
            #pyautogui.PAUSE = 2
    #Si es detectada la direccion Sur, presionar el boton de la flecha para abajo.
    elif direction == 'Sur':
